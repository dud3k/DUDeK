...
0. **Jedna sesja na checkout.** Nie pracuj równolegle z inną sesją (np. architektem) w tym samym
   katalogu — dwie sesje ścigają się o HEAD i staging gita. Właściciel uruchamia role sekwencyjnie.
